...
string Client::getClearingId() const { return clearingID; }
string Client::getFirmName() const { return firmName; }
string Client::getAddress() const { return address; }
int Client::getBalance() const { return balance; }
