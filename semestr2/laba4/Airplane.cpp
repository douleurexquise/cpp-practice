...
Airplane::Airplane() : year(0), seats(0), capacity(0.0) {}
...
int Airplane::get_year() { return year; }
int Airplane::get_seats() { return seats; }
double Airplane::get_capacity() { return capacity; }
...
void Airplane::set_year(int _year) { year = _year; }
void Airplane::set_seats(int _seats) { seats = _seats; }
void Airplane::set_capacity(double _capacity) { capacity = _capacity; }
